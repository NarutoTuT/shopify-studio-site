...
export function ShopifyWebsiteBuildPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <PageStructuredData breadcrumbs={structuredData.breadcrumbs} service={structuredData.service} language={language} />
      <Navbar />
          ...
          <div className="mx-auto max-w-[1500px]">
            ...
            <ServiceFaqPanel
              entries={text.faqs.map((item, index) => ({
                question: item.q,
                answer: item.a,
                category: websiteBuildFaqMeta[index].code,
                tags: websiteBuildFaqMeta[index][language],
              }))}
              activeIndex={activeFaq}
              onActiveIndexChange={setActiveFaq}
              panelId="website-build-faq-answer"
              accordionPrefix="faq"
              statusLabel="Engineering knowledge / online"
